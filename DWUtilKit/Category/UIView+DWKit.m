...
- (void)dw_drawCornerRadius:(CGFloat)radius corners:(UIRectCorner)corners {
    [self dw_drawCornerRadius:radius corners:corners roundedRect:self.bounds];
}
...
- (UIImage *)dw_snapshotImageAfterScreenUpdates:(BOOL)afterUpdate {
